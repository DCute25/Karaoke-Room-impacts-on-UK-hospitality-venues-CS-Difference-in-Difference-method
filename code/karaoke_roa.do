...
***Without covariates (uncodnitional parallel trend assumptions)
...
***Visualize Group-Time Average Treatment Effects - Unconditional parallel trend
...
***Visualize Group-Time Average Treatment Effects - Conditional parallel trend 
...
egen avg_not_yet = mean(not_yet), by(year)
	...
	//Plot parallel trend vs Not-yet and Never Treated  control group
